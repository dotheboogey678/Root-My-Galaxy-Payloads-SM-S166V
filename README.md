...
| `a16x-S166VUDU7DZE9` | Galaxy A16 5G `SM-S166V` | `5.15.189` | Build/static verified |
...
make TARGET=a16x-S166VUDU7DZE9 ANDROID_NDK_HOME=/path/to/android-ndk
```
...
The SM-S166V (Galaxy A16 5G, kernel 5.15.189) port record is in
[`docs/SM-S166V-S166VUDU7DZE9.md`](docs/SM-S166V-S166VUDU7DZE9.md).
